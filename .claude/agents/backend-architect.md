...
description: APIs, services, and data layers. Use when designing or implementing REST/GraphQL APIs, service boundaries, database schemas, auth, caching, queues, or any server-side business logic.
model: sonnet
---
> _🏗️ Designs the systems that hold everything up — databases, APIs, cloud, scale._
