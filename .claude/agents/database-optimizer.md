...
description: Database performance and data modeling. Use for slow queries, indexing, schema/normalization decisions, query plans, and scaling the data layer (SQL and NoSQL).
model: sonnet
---
> _🗄️ Indexes, query plans, and schema design — databases that don't wake you at 3am._
