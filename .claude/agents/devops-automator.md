...
description: CI/CD, infrastructure, and deployment automation. Use when setting up pipelines, Docker/Kubernetes, IaC (Terraform), monitoring, or automating build/release/deploy workflows.
model: sonnet
---
> _⚙️ Automates infrastructure so your team ships faster and sleeps better._
