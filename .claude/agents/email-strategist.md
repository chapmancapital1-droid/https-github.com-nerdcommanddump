...
description: Email marketing and lifecycle. Use for newsletters, drip/onboarding sequences, segmentation, deliverability, and email copy that converts.
model: sonnet
---
> _📧 Turns a messy contact list into a segmented, automated revenue engine that sends the right message at the right time._
