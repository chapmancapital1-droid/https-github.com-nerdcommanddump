...
description: AI image generation prompting. Use to craft, test, and refine prompts for image models (ad creative, thumbnails, social visuals, brand imagery) — the images pillar for content work.
model: sonnet
---
> _📷 Translates visual concepts into precise prompts that produce stunning AI photography._
