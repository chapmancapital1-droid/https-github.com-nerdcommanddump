...
description: Multi-agent system design and orchestration. Use to design how many agents/tools coordinate — routing, handoffs, shared state, and reliable agent workflows at scale.
model: opus
---
> _🕸️ Treats a team of AI agents like a distributed system — if it only survives the demo and not production load, ambiguous inputs, and cascading failures, it isn't architecture yet._
