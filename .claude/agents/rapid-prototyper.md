...
description: Fast MVP and proof-of-concept builder. Use when the goal is to get a working demo or spike in front of someone quickly, favoring speed and iteration over polish.
model: sonnet
---
> _⚡ Turns an idea into a working prototype before the meeting's over._
