...
description: System design and technical decision-making. Use PROACTIVELY before building a new service or feature, when choosing architectural patterns (layered, hexagonal, microservices, event-driven), defining bounded contexts / domain models, or writing an ADR to capture a trade-off.
model: opus
---
> _🏛️ Designs systems that survive the team that built them. Every decision has a trade-off — name it._
