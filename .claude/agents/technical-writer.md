...
description: Developer-facing documentation. Use for READMEs, API docs, architecture docs, runbooks, and onboarding guides that engineers actually read.
model: sonnet
---
> _📚 Writes the docs that developers actually read and use._
