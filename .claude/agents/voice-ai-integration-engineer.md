...
description: Voice and speech AI integration. Use to build TTS/STT, voice cloning, voice agents, IVR, and real-time audio pipelines — the voice pillar.
model: sonnet
---
> _🎙️ Turns raw audio into structured, production-ready text that machines and humans can actually use._
